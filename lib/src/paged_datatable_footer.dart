                        ...
                        children: [
                          ...
                          if (theme.configuration.allowRefresh) ...[
                            ...
                            Padding(
                                ...
                                child: VerticalDivider(indent: 10, endIndent: 10, color: theme.dividerColor)),
                          ],

                          /* ROWS PER PAGE */
                          if (theme.configuration.pageSizes != null && theme.configuration.pageSizes!.isNotEmpty) ...[
                            Row(
                          ...
                          if (theme.configuration.footer.showTotalElements)
                            Text(localization.totalElementsText(state.tableCache.currentLength))
                          else
                            Text(localization.pageIndicatorText(state.tableCache.currentPageIndex)),
                          Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 12.0),
                              child: VerticalDivider(indent: 10, endIndent: 10, color: theme.dividerColor)),
