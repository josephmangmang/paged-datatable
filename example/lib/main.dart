...
const kCustomPagedDataTableTheme = PagedDataTableThemeData(
    ...
    chipTheme: ChipThemeData(
        backgroundColor: Colors.teal, labelStyle: TextStyle(color: Colors.white), deleteIconColor: Colors.white),
    ...
    return Padding(
      ...
      child: PagedDataTable<String, Post>(
        ...
        columns: [
          ...
          TableColumn(title: "Fixed Value", cellBuilder: (item) => const Text("abc"), sizeFactor: null),
        ],
        filters: [
          TextTableFilter(id: "authorName", title: "Author's name", chipFormatter: (text) => "By $text"),
